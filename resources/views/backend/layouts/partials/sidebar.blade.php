    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="active">
                    <a href="{{ asset('../dashboard/index.html') }}" class=" "> 
                        <i class="las la-newspaper"></i><span>Newsfeed</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{ asset('../app/profile.html') }}" class=" ">
                        <i class="las la-user"></i><span>Profile</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{ asset('../app/group.html') }}" class=" ">
                        <i class="las la-users"></i><span>Group</span>
                    </a>
                </li>
                <li class=" ">
                    <a href="{{ asset('../app/todo.html') }}" class=" ">
                        <i class="las la-check-circle"></i><span>Todo</span>
                    </a>
                </li>
                <li class=" ">
                    <a href="{{ asset('../dashboard/calendar.html') }}" class=" ">
                ...
                <li class=" ">
                    ...
                    <ul id="mailbox" class="iq-submenu collapse" data-bs-parent="#iq-sidebar-toggle">
                        <li class="">
                            <a href="{{ asset('') }}../app/email.html"><i class="  ri-inbox-line"></i>Inbox</a>
                        </li>
                        <li class="">
                            <a href="{{ asset('') }}../app/email-compose.html"><i class="ri-edit-line"></i>Email Compose</a>
                        </li>
                    </ul>
                </li>
                <li class="">
