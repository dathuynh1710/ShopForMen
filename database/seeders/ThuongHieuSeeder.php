...
class ThuongHieuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $row1 = [
            ...
            'hinhanh'       => 'thuonghieu/img/ava.jpg',
        ...
        $row2 = [
            ...
            'hinhanh' => 'thuonghieu/img/Logo_cong_ty_sunhouse.png',
            'created_at'    => date('Y-m-d H:i:s')
        ];
        ...
        $row3 = [
            ...
            'hinhanh' => 'thuonghieu/img/Kangaroo.jpg',
            'created_at'    => date('Y-m-d H:i:s')
        ];
        ...
        $row4 = [
            ...
            'hinhanh' => 'thuonghieu/img/hoaphat.png',
            'created_at'    => date('Y-m-d H:i:s')
        ];
        ...
        $row5 = [
            ...
            'hinhanh' => 'thuonghieu/img/Samsung_Logo.png',
            'created_at'    => date('Y-m-d H:i:s')
        ];
        ...
        $row6 = [
            ...
            'hinhanh' => 'thuonghieu/img/panasonic.png',
            'created_at'    => date('Y-m-d H:i:s')
        ];
        ...
        $row7 = [
            ...
            'hinhanh' => 'thuonghieu/img/SHARP.png',
            'created_at'    => date('Y-m-d H:i:s')
        ];
        ...
        $row8 = [
            ...
            'hinhanh' => 'thuonghieu/img/MUTOSI.png',
            'created_at'    => date('Y-m-d H:i:s')
        ];
        ...
        $row9 = [
            ...
            'hinhanh' => 'thuonghieu/img/logo-thuong-hieu-karofi.png',
            'created_at'    => date('Y-m-d H:i:s')
        ];
        ...
        $row10 = [
            ...
            'hinhanh' => 'thuonghieu/img/Philips_logo.png',
            'created_at'    => date('Y-m-d H:i:s')
        ];
