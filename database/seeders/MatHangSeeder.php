    ...
    public function run(): void
    {
        DB::table('mathang')->insert([
            [
                ...
                'giaban'       => 7590000,
                'soluongton'       => 20,
                'hinhanh' => 'may-loc-nuoc-ro-nong-nguoi-lanh-kangaroo-kg10a17-10-loi-5.jpg',
                'noibat'       => false,
                'danhmuc_id'       => 1,
                'thuonghieu_id'       => 3,
            ...
            [
                ...
                'giaban'       => 3590000,
                'soluongton'       => 10,
                'hinhanh' => 'bep-hong-ngoai-doi-sunhouse-shb9112mt.jpg',
                'noibat'       => true,
                'danhmuc_id'       => 3,
                'thuonghieu_id'       => 2,
                'created_at'    => date('Y-m-d H:i:s')
            ...
            [
                ...
                'giaban'       => 1890000,
                'soluongton'       => 5,
                'hinhanh' => 'noi-com-dien-tu-sharp-18-lit-ks-com194ev.jpg',
                'noibat'       => true,
                'danhmuc_id'       => 4,
                'thuonghieu_id'       => 7,
                'created_at'    => date('Y-m-d H:i:s')
            ...
            [
                ...
                'giaban'       => 1550000,
                'soluongton'       => 16,
                'hinhanh' => 'may-ep-trai-cay-panasonic-mj-cs100wra1.jpg',
                'noibat'       => true,
                'danhmuc_id'       => 5,
                'thuonghieu_id'       => 6,
                'created_at'    => date('Y-m-d H:i:s')
            ...
            [
                ...
                'giaban'       => 1790000,
                'soluongton'       => 7,
                'hinhanh' => 'samsung-vc18m21m0vn-sv-n.jpg',
                'noibat'       => false,
                'danhmuc_id'       => 6,
                'thuonghieu_id'       => 5,
                'created_at'    => date('Y-m-d H:i:s')
            ...
            [
                ...
                'giaban'       => 2670000,
                'soluongton'       => 12,
                'hinhanh' => 'may-loc-khong-khi-philips-ac0650-10-12w.jpg',
                'noibat'       => false,
                'danhmuc_id'       => 7,
                'thuonghieu_id'       => 10,
                'created_at'    => date('Y-m-d H:i:s')
